...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && $pdo) {
    ...
    if (empty($errors)) {
        try {
            $stmt = $pdo->prepare("SELECT id, username, email, password_hash FROM users WHERE username = :user OR email = :user");
...
<head>
    ...
    <title>Sign In - AID-X: Smart Giving Timely Living</title>
            ...
            <div class="w-full max-w-6xl mx-auto grid lg:grid-cols-2 min-h-[80vh]">
                ...
                <div class="hidden lg:flex flex-col justify-center items-center p-12 bg-white/5 backdrop-blur-md rounded-l-3xl">
                    <div class="text-center">
                        <div class="mb-8">
                            <img src="../assets/WhatsApp%20Image%202025-11-15%20at%2021.33.16.jpeg" alt="AID-X Logo" class="w-24 h-24 mx-auto mb-6 rounded-full object-cover">
                            <h1 class="text-5xl font-bold text-white mb-4">AID-<span class="text-secondary">X</span></h1>
                            <p class="text-xl text-gray-300 mb-8">Smart Giving Timely Living</p>
                        </div>
