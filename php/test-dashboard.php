    ...
    <header class="bg-white/10 backdrop-blur-md border-b border-white/20">
        <nav class="flex justify-between items-center max-w-7xl mx-auto px-6 py-4">
            ...
            <div class="flex items-center space-x-4">
                ...
                <a href="../index.html" class="bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded-lg transition duration-200">
                ...
                <table class="w-full">
                    ...
                    <tbody>
                        <tr class="border-b border-white/10 hover:bg-white/5 transition-colors">
                            ...
                            <td class="px-6 py-4">
                                <span class="bg-primary/20 text-primary px-3 py-1 rounded-full text-sm">Food</span>
                            </td>
                            <td class="px-6 py-4">
                            ...
                            <td class="px-6 py-4 text-gray-300">2024-01-15</td>
                            <td class="px-6 py-4 text-gray-300">Emergency food assistance needed</td>
                        </tr>
                        <tr class="border-b border-white/10 hover:bg-white/5 transition-colors">
                            <td class="px-6 py-4 text-gray-300">#2</td>
                            <td class="px-6 py-4">
                                <span class="bg-primary/20 text-primary px-3 py-1 rounded-full text-sm">Medical</span>
                            </td>
                            <td class="px-6 py-4">
                            ...
                            <td class="px-6 py-4 text-gray-300">2024-01-10</td>
                            <td class="px-6 py-4 text-gray-300">Medical supplies for elderly care</td>
                        </tr>
                    </tbody>
                </table>
            </div>
